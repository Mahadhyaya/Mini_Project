<?php
    ...
    if (!$bool) {
        $sql = "INSERT INTO `seller` (`emailid`, `sname`, `mobileno`, `city`, `zipcode`, `street`, `password`, `confirm_password`, `paid`) VALUES ('$emailid', '$name', '$mobile', '$city',  '$zip', '$street', '$password', '$repeat' , 1)";  
        if ($con->query($sql)) {
            $boos = true;
...
<body style="overflow: hidden;background-color: rgb(242, 212, 212);background-image:url('./images/backg.webp');z-index:-800; background-blend-mode: saturation;">
    <form action="SellerSignUp.php" method="post" style="z-index: 1000;">
        <div class="container">    
