...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section">
    		...
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Grapes</a></h3>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/product_6.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Rambutan</a></h3>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-3 ftco-animate">
		...
		<section class="ftco-section img" style="background-image: url(images/bg-3.jpg);">
    	<div class="container">
				<div class="row justify-content-end">
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
          	<span class="subheading">Best Price Only For You</span>
            <h2 class="mb-4">WE PROVIDE BEST ORGANIC FRUITS FOR YOU...</h2>
          </div>
        </div>   		
    	</div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <p>Good initiation for a healthy life starts with orgainc and here we get most of the orgainc fruits with a better price</p>
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(images/cust1.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Eating healthy fruits makes my day Thank you Go-organic</p>
                    <p class="name">Soorya Kumar M H</p>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(images/cust2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Go-Orgainc gone crazy to bring the good fruits for good price</p>
                    <p class="name">Puneeth Raj K</p>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(images/cust3.jpeg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Conserving Organic Encourages our Atmospher and Nature</p>
                    <p class="name">Vineeth Raj K</p>
                    <span class="position">Socialist</span>
                  </div>
                </div>
              </div>
            </div>
